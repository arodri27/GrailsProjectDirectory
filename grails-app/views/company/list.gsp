...
<html>
	...
	<body>
		...
		<div id="list-company" class="content scaffold-list">
			...
			<table>
				...
				<g:each in="${companyInstanceList}" status="i" var="companyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link class="black" action="show" id="${companyInstance.id}">${fieldValue(bean: companyInstance, field: "companyName")}</g:link></td>
